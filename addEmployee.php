...
<body>
    <div class="form_container">
        <div class="features">
            <form  method="POST" action="./upload.php" enctype="multipart/form-data" class="">
                <!-- <p class="title">Select image to upload:</p> -->
        ...
        <div class="features">
            <input type="submit" onclick="addEmployee()" class="btn" name="save" value="Save">
