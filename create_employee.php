...
<body>
    <div class="form_container">
        ...
        <div class="features">
                ...
                <input type="text" name="name" placeholder="Your Full Name" class="text_box" id="fname">
    ...
    <script>
        function changeImg() {
            ...
            $("#file_upload").change((e) => {
                ...
                if(img.length > 0) {
                    ...
                    $("#imgErr").text("Please select an image to upload!!!")
                }
            })
        };
        ...
        //  checking blank input
            if(!$("#fname").val().length) {
                ...
                $("#ageErr").text("Your age is required!!!");
                ...
                $("#skillsErr").text("Select at least one!!!");
